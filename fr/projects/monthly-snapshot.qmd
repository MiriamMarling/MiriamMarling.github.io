...
- **Devenus inactifs.** Personnes n'ayant pas utilisé les services d'hébergement
  au cours des trois derniers mois, y compris le mois de référence.
...
_spikeTopSector === "men"
  ? md`[Ce constat est également mis en évidence ici : Détection de pics d'occupation →](spike-detection.html)`
  : html``
```
