  ...
  html:
    ...
    include-in-header:
      text: |
        ...
        .kpi-hero .kpi-box { display: inline-block; background: #E8E8E8; padding: 1rem 2.5rem; border-radius: 0.5rem; max-width: 100%; }
        .kpi-hero .kpi-label { font-size: 0.9rem; font-weight: 500; color: #666; margin-bottom: 0.5rem; }
        .kpi-hero .kpi-value { font-size: 2.5rem; font-weight: 700; color: #333; }
